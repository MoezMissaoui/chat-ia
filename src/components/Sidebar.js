  ...
  return (
    <div className={`bg-gray-900 text-white transition-all duration-300 flex flex-col ${
      ...
      <div className={`${isCollapsed ? 'p-2' : 'p-3'}`}>
        <button
          onClick={onNewChat}
          className={`w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 transform hover:scale-105 active:scale-95 ${
            isCollapsed 
        ...
        {/* Enhanced visual indicator when collapsed */}
        {isCollapsed && (
            ...
            >
              {isCollapsed ? (
                ...
                <div className="flex items-center justify-between">
                    ...
                    {hoveredConversation === conversation.id && renamingConversation !== conversation.id && (
                      <div className="relative" ref={dropdownRef}>
                        <button
                          onClick={(e) => handleToggleDropdown(conversation.id, e)}
                          className="p-1 rounded hover:bg-gray-600 transition-colors opacity-0 group-hover:opacity-100"
                          title="More actions"
                        >
