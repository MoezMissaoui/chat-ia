/**
 * AuthForm Component - Login and Registration Form
 * Follows Single Responsibility Principle by handling only authentication forms
 ...
 * @param {Function} props.onClose - Callback to close the auth modal
